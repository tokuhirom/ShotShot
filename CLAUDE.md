...
## Tasks
 ...
 - [ ] Crop 機能｡Crop ボタンを押すと､画像の範囲をえらんで､その範囲以外の部分の画像はない物になる｡
 - [ ] ドロップダウンメニューの色選択のところに色が実際に表示されていること｡
 - [ ] Cmd-S で画像を名前をつけて保存できること｡
 - [ ] Cmd-V でクリップボードから画像を取得し､それを編集したい
 - [ ] 画像選択と矢印のアイコンが似すぎててよくわからん｡もう少しわかりやすく｡
