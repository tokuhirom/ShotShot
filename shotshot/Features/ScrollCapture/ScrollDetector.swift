...
final class ScrollDetector {
    ...
    private let cooldownInterval: TimeInterval = 0.5  // 500ms cooldown between captures
    private let comparisonInterval: TimeInterval = 0.3  // 300ms between comparisons
    private let changeThreshold: Float = 0.05  // 5% difference triggers capture
